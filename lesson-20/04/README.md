# Quart API with Hypercorn

In this lesson, we will create a simple RESTful API using the Quart web framework and deploy it using Hypercorn. The API will have a single endpoint that returns a greeting message.
